import volkiharBackgroundLarge from 'assets/volkihar-background-large1.jpg';
import volkiharBackgroundPlaceholder from 'assets/volkihar-background-placeholder.jpg';
import volkiharBackground from 'assets/volkihar-background1.jpg';
import volkiharBannerLarge from 'assets/chatbot.jpeg';
import volkiharBannerPlaceholder from 'assets/volkihar-banner-placeholder.jpg';
import volkiharBanner from 'assets/chatbot.jpeg';
...
import volkiharEnderalLarge from 'assets/volkihar-enderal-large1.jpg';
...
import volkiharEnderal from 'assets/volkihar-enderal1.jpg';
...
const title = 'Ai Solutions';
const description =
  'Custom Solutions Tailored to Your Unique Needs, Amplifying Efficiency and Driving Innovation.';
const roles = [
        ...
        <ProjectSection>
          <ProjectSectionContent>
            ...
            <ProjectTextRow center noMargin>
              <ProjectSectionHeading>The Bleeding Edge of Tech</ProjectSectionHeading>
              <ProjectSectionText>
                Experience the future of customer engagement with AI-powered chatbots.
                Simplify document management and streamline workflows with AI-driven
                document automation software. Embrace efficiency and productivity like
                never before.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        ...
        >
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              /> */}
              <ProjectSectionHeading>Get Ahead of Your Competition</ProjectSectionHeading>
              <ProjectSectionText>
                Experience the power of customized AI solutions tailored for small
                businesses. Stay ahead of the competition with AI-driven innovation,
                unlocking new efficiencies, insights, and growth opportunities for your
                business.
              </ProjectSectionText>
              <Button
                secondary
                iconHoverShift
                icon="chevronRight"
                href="https://calendly.com/d/z6g-8d7-dnp/introductory-call"
              >
                Book a Consultation.
              </Button>
            </ProjectTextRow>
