...
import profileImgLarge from 'assets/profile1-large.jpg';
...
const ProfileText = ({ visible, titleId }) => (
  <Fragment>
    ...
    <Text className={styles.description} data-visible={visible} size="l" as="p">
      ...
      businesses to unparalleled success in a digital-first world. Quality is our
      obsession. Every line of code, pixel, and interaction is perfected for your success.
